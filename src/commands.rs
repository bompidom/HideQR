...
pub fn print_help() {
    ...
    println!("-create [file location] [txt-message1] [txt-message2] : Creates a file at the specified location with two text messages.");
...
pub fn create_qr_code(file_location: &str, message1: &str, message2: &str) {
    ...
    match qr.embed(message2){
        ...
        Err(e) => panic!("{} Please shorten the secret message or increase the dummy data.", e, ),
    }
